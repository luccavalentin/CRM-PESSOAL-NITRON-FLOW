...
export default function Button({
  ...
  const variantClasses = {
    primary: 'bg-accent-electric text-gray-100 hover:bg-accent-cyan focus:ring-accent-electric',
    secondary: 'bg-card-bg text-gray-300 hover:bg-card-hover border border-card-border focus:ring-card-border',
    danger: 'bg-red-600 text-gray-100 hover:bg-red-700 focus:ring-red-600',
