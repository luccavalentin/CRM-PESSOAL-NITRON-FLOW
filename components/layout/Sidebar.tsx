    ...
    children: [
      {
        ...
        children: [
          { id: 'fluxo-caixa', label: 'Fluxo de Caixa', path: '/empresa/financeiro/fluxo-caixa' },
          { id: 'reserva-emergencia', label: 'Reserva de Emergência', path: '/empresa/financeiro/reserva' },
          { id: 'aplicacoes', label: 'Investimentos', path: '/empresa/financeiro/aplicacoes' },
          { id: 'objetivos-financeiros', label: 'Objetivos', path: '/empresa/financeiro/objetivos' },
        ],
      },
      {
        id: 'projetos',
        ...
        children: [
          { id: 'tarefas', label: 'Tarefas', path: '/empresa/tarefas' },
          { id: 'projetos-list', label: 'Projetos', path: '/empresa/projetos' },
          { id: 'brainstorm', label: 'Brainstorm', path: '/empresa/brainstorm' },
          { id: 'ideias', label: 'Ideias', path: '/empresa/ideias' },
          { id: 'deploys', label: 'Deploys', path: '/empresa/deploys' },
          { id: 'usuarios', label: 'Usuários e Licenças', path: '/empresa/usuarios' },
          { id: 'desempenho', label: 'Desempenho', path: '/empresa/desempenho' },
          { id: 'suporte', label: 'Suporte', path: '/empresa/suporte' },
        ],
      },
      {
        id: 'cliente',
        ...
        children: [
          { id: 'crm', label: 'CRM', path: '/empresa/cliente/crm' },
          { id: 'leads', label: 'Leads', path: '/empresa/cliente/leads' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      { id: 'dashboard-pessoal', label: 'Dashboard', path: '/pessoal/dashboard', icon: <LayoutDashboard className="w-3.5 h-3.5" /> },
      {
        ...
        icon: <Wallet className="w-3.5 h-3.5" />,
        children: [
          { id: 'controle-financas', label: 'Controle', path: '/pessoal/financeiro/controle' },
          { id: 'reserva-emergencia-pessoal', label: 'Reserva', path: '/pessoal/financeiro/reserva' },
          { id: 'aplicacoes-pessoal', label: 'Investimentos', path: '/pessoal/financeiro/aplicacoes' },
          { id: 'lista-compras', label: 'Lista de Compras', path: '/pessoal/financeiro/lista-compras' },
          { id: 'objetivos-financeiros-pessoal', label: 'Objetivos', path: '/pessoal/financeiro/objetivos' },
        ],
      },
      {
        id: 'produtividade',
        ...
        children: [
          { id: 'estudos', label: 'Estudos', path: '/pessoal/produtividade/estudos' },
          { id: 'tarefas-pessoais', label: 'Tarefas', path: '/pessoal/produtividade/tarefas' },
          { id: 'projetos-pessoais', label: 'Projetos', path: '/pessoal/produtividade/projetos' },
        ],
      },
      {
        id: 'desenvolvimento',
        ...
        children: [
          { id: 'chuva-ideias', label: 'Ideias', path: '/pessoal/desenvolvimento/ideias' },
          { id: 'autodesenvolvimento', label: 'Autodesenvolvimento', path: '/pessoal/desenvolvimento/autodesenvolvimento' },
          { id: 'habitos', label: 'Hábitos', path: '/pessoal/desenvolvimento/habitos' },
          { id: 'livros', label: 'Livros', path: '/pessoal/desenvolvimento/livros' },
          { id: 'metas-anuais', label: 'Metas Anuais', path: '/pessoal/desenvolvimento/metas' },
        ],
      },
      {
        id: 'vida-saudavel',
        ...
        children: [
          { id: 'alimentacao', label: 'Alimentação', path: '/pessoal/vida-saudavel/alimentacao' },
          { id: 'treinos', label: 'Treinos', path: '/pessoal/vida-saudavel/treinos' },
          { id: 'sono', label: 'Sono', path: '/pessoal/vida-saudavel/sono' },
        ],
      },
      {
        id: 'espiritualidade',
        ...
        icon: <Sparkles className="w-3.5 h-3.5" />,
        children: [
          { id: 'lei-atracao', label: 'Lei da Atração', path: '/pessoal/espiritualidade/lei-atracao' },
          { id: 'astrologia', label: 'Astrologia', path: '/pessoal/espiritualidade/astrologia' },
        ],
      },
      {
        id: 'trading',
        ...
        children: [
          { id: 'dashboard-trading', label: 'Dashboard', path: '/pessoal/trading/dashboard' },
          { id: 'sessao-operacao', label: 'Sessão', path: '/pessoal/trading/sessao' },
          { id: 'configuracoes-trading', label: 'Configurações', path: '/pessoal/trading/configuracoes' },
        ],
      },
    ],
  },
