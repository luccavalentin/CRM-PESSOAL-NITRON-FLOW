...
/**
 * Remove todos os leads de Piracicamirim do sistema
 */
export const cleanLeadsPiracicamirim = () => {
...
/**
 * Limpa todos os dados mockados do localStorage
 */
export const cleanMockData = () => {
  ...
  if (leadsStorage) {
    try {
      ...
      // Manter apenas leads que não são mockados (verificar por padrões conhecidos)
